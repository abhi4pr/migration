...
export default function SubDepartmentUpdate() {
  ...
  function getData() {
    ...
    axios
      .get(`https://api-dot-react-migration-project.el.r.appspot.com/api/get_subdept_from_id/${id}`)
      .then((res) => {
  ...
  async function handleSubmit(e) {
    ...
    await axios.put(`https://api-dot-react-migration-project.el.r.appspot.com/api/update_sub_department`, {
      id: Number(id),
