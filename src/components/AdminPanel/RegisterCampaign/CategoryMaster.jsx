...
export default function CategoryMaster() {
  ...
  const handleSave = (e) => {
    e.preventDefault();
    axios
      .post("https://node-dev-server.onrender.com/api/projectxCategory", postData)
      .then((response) => {
  ...
  // get api ========>
  const getData = () => {
    axios.get("https://node-dev-server.onrender.com/api/projectxCategory").then((res) => {
  ...
  const handlePutData = () => {
    axios
      .put(`https://node-dev-server.onrender.com/api/projectxCategory`, {
  ...
  //   axios.delete(`https://node-dev-server.onrender.com/api/projectxCategory/${id}`).then((res) => {
  //     getData();
  ...
  const handleConfirmDelete = () => {
    if (itemToDeleteId) {
      axios
        .delete(
          `https://node-dev-server.onrender.com/api/projectxCategory/${itemToDeleteId}`
        )
        .then(() => {
          getData();
