...
const CampaignDetailes = ({
  ...
  const getData = async () => {
    try {
      const res = await axios.get(
        `https://node-dev-server.onrender.com/api/register_campaign/${cid}`
      );
  ...
  const getBrandInfo = async () => {
    const brand = await axios.get(`https://node-dev-server.onrender.com/api/get_brands`);
  ...
  const getCampaignName = async () => {
    const camp = await axios.get(`https://node-dev-server.onrender.com/api/exe_campaign`);
  ...
  const getCommitments = async () => {
    const comm = await axios.get(
      "https://node-dev-server.onrender.com/api/get_all_commitments"
    );
