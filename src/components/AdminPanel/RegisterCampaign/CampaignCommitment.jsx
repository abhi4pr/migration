...
export default function CampaignCommitment() {
  ...
  const handleSave = (e) => {
    ...
    axios
      .post("https://api-dot-react-migration-project.el.r.appspot.com/api/exe_campaign", postData)
      .then((response) => {
  ...
  // get api ========>
  const getData = () => {
    axios.get("https://api-dot-react-migration-project.el.r.appspot.com/api/exe_campaign").then((res) => {
  ...
  const handlePutData = () => {
    axios
      .put(`https://api-dot-react-migration-project.el.r.appspot.com/api/exe_campaign`, {
  ...
  const handleConfirmDelete = () => {
    if (itemToDeleteId) {
      axios
        .delete(`https://api-dot-react-migration-project.el.r.appspot.com/api/exe_campaign/${itemToDeleteId}`)
        .then(() => {
          getData();
