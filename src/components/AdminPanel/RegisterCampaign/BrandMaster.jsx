...
export default function BrandMaster() {
  ...
  const handleSave = (e) => {
    ...
    axios
      .post("https://node-dev-server.onrender.com/api/add_brand", postData)
      .then((response) => {
  ...
  const handlePutData = () => {
    axios
      .put(`https://node-dev-server.onrender.com/api/edit_brand`, {
  ...
  const handleConfirmDelete = () => {
    if (itemToDeleteId) {
      axios
        .delete(`https://node-dev-server.onrender.com/api/delete_brand/${itemToDeleteId}`)
        .then(() => {
          getData();
