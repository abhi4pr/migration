...
const SaleBookingVerify = () => {
  ...
  function getData() {
    axios
      .post(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/add_php_sale_booking_tds_verification_data_in_node"
      )
      .then((res) => {
    ...
    axios
      .get(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_php_sale_booking_tds_verification_data"
      )
      .then((res) => {
