...
const IncentivePayment = () => {
  ...
  function getData() {
    axios.post("https://jarvis-work-backend.onrender.com/api/add_php_payment_incentive_data_in_node").then((res)=>{
      console.log('data save in local success')
    })
    axios.get("https://jarvis-work-backend.onrender.com/api/get_all_php_payment_incentive_data").then((res) => {
