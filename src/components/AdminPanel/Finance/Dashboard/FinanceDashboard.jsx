...
const handleResetClick = () => {
  ...
  const callApi = () => {
    ...
    axios
      .post("https://api-dot-react-migration-project.el.r.appspot.com/api/add_php_finance_data_in_node")
      .then(() => {
        console.log("data save in local success");
      });
    axios
      .get("https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_php_finance_data_pending")
      .then((res) => {
    ...
    axios
      .post(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/add_php_sale_booking_tds_data_in_node"
      )
      .then(() => {
        console.log("data save in local success");
      });
    ...
    axios
      ...
      axios
      .post(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/add_php_payment_incentive_data_in_node"
      )
      .then(() => {
        console.log("data save in local success");
      });
