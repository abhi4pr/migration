...
export default function PendingPaymentRequest() {
  ...
  const callApi = () => {
    axios
      .get(`https://api-dot-react-migration-project.el.r.appspot.com/api/addPhpVendorPaymentRequest`)
      .then((res) => {
        console.log(res);
      });
  ...
  const handlePayVendorClick = () => {
    ...
    axios
      .post("https://api-dot-react-migration-project.el.r.appspot.com/api/phpvendorpaymentrequest", formData, {
        headers: {
  ...
  const handleDiscardClick = (row) => {
    ...
    // axios
    //   .delete(`https://api-dot-react-migration-project.el.r.appspot.com/api/delete_demo/${row._id}`)
    //   .then(() => {
    //     callApi();
    //   });
  };
