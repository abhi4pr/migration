...
const AllTransactions = () => {
  ...
  function getData() {
    axios
      .post("https://api-dot-react-migration-project.el.r.appspot.com/api/add_php_payment_acc_data_in_node")
      .then((res) => {
        console.log("data save in local success");
      });
    axios
      .get("https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_php_finance_data")
      .then((res) => {
    ...
    axios
      .get("https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_php_payment_acc_data")
      .then((res) => {
