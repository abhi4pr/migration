...
const DashboardWFHUser = () => {
  ...
  const getDepartment = async () => {
    try {
      const response = await axios.get(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/all_departments_of_wfh"
      );
  ...
  const getTotalSalary = async () => {
    try {
      const response = await axios.get(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/get_total_salary"
      );
  ...
  const getAnniversaryBirthdays = async () => {
    try {
      const responseDOB = await axios.get(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_users_with_dob"
      );
      const responseDOJ = await axios.get(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_users_with_doj"
      );
  ...
  const getThisMonthJoinees = async () => {
    try {
      const response = await axios.get(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/get_last_month_users"
      );
