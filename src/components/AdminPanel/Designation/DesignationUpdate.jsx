...
const DesignationUpdate = () => {
  ...
  useEffect(() => {
    const fetchDepartmentData = async () => {
      try {
        const response = await axios.get(
          "https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_departments"
        );
    ...
    const fetchDesignationData = async () => {
      try {
        const response = await axios.get(
          `https://api-dot-react-migration-project.el.r.appspot.com/api/get_single_designation/${desi_id}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        "https://api-dot-react-migration-project.el.r.appspot.com/api/update_designation",
        designationData
      );
