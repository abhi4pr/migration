...
const DataBrand = () => {
    ...
    try {
      ...
      if (isModalExists) {
        ...
        const response = await axios.post(
          "https://api-dot-react-migration-project.el.r.appspot.com/api/add_data_brand",
          {
  ...
  async function getModalData() {
    const res = await axios.get(
      "https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_data_brands"
    );
  ...
  const handleModalUpdate = () => {
    axios
      .put("https://api-dot-react-migration-project.el.r.appspot.com/api/update_data_brand", {
        _id: modalId,
