...
const ContentType = () => {
    ...
    try {
      ...
      if (isModalExists) {
        ...
        const response = await axios.post(
          "https://api-dot-react-migration-project.el.r.appspot.com/api/add_data_content_type",
          {
  ...
  async function getModalData() {
    const res = await axios.get(
      "https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_data_content_types"
    );
  ...
  const handleModalUpdate = () => {
    axios
      .put("https://api-dot-react-migration-project.el.r.appspot.com/api/update_data_content_type", {
        _id: modalId,
