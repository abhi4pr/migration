...
const DataSubCategory = () => {
  ...
  async function getModalData() {
    const res = await axios.get(
      "https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_data_Sub_categories"
    );
  ...
  const handleModalUpdate = () => {
    axios
      .put("https://api-dot-react-migration-project.el.r.appspot.com/api/update_data_sub_category", {
        _id: modalId,
