...
const DataCategory = () => {
  ...
  const handleSubCategroy = async (row) => {
    try {
      const response = await axios.get(
        `https://api-dot-react-migration-project.el.r.appspot.com/api/get_data_sub_category_from_categoryid/${row}`
      );
  ...
  const handleSubmitSub = async (e) => {
    ...
    try {
        ...
        const response = await axios.post(
          "https://api-dot-react-migration-project.el.r.appspot.com/api/add_data_sub_category",
          {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isModalExists) {
        ...
        const response = await axios.post(
          "https://api-dot-react-migration-project.el.r.appspot.com/api/add_data_category",
          {
  ...
  async function getModalData() {
    const res = await axios.get(
      "https://api-dot-react-migration-project.el.r.appspot.com/api/get_all_data_categorys"
    );
  ...
  const handleModalUpdate = () => {
    axios
      .put("https://api-dot-react-migration-project.el.r.appspot.com/api/update_data_category", {
        _id: modalId,
