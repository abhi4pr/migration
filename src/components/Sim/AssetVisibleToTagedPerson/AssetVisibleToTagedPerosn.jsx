...
const AssetVisibleToTagedPerosn = () => {
  ...
  const getData = async () => {
    try {
      const response = await axios.get(
        `https://api-dot-react-migration-project.el.r.appspot.com/api/show_asset_user_data/${userID}`
      );
  ...
  const getNewAssetData = async () => {
    try {
      const response = await axios.get(
        `https://api-dot-react-migration-project.el.r.appspot.com/api/show_new_asset_user_data/${userID}`
      );
