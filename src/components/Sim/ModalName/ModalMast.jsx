...
const ModalMast = () => {
    ...
    try {
      ...
      if (isModalExists) {
        ...
        const response = await axios.post(
          "https://api-dot-react-migration-project.el.r.appspot.com/api/add_asset_modal",
          {
  ...
  const handleModalUpdate = () => {
    ...
    axios
      .put("https://api-dot-react-migration-project.el.r.appspot.com/api/update_asset_modal", {
