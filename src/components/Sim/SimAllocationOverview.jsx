...
const SimAllocationOverview = () => {
  ...
  function getData() {
    axios
      .get("https://api-dot-react-migration-project.el.r.appspot.com/api/alldataofsimallocment")
      .then((res) => {
  ...
  const getSimData = (row) => {
    ...
    axios
      .get(`https://api-dot-react-migration-project.el.r.appspot.com/api/get_single_sim/${row.sim_id}`)
      .then((res) => {
    ...
    axios
      .get(
        `https://api-dot-react-migration-project.el.r.appspot.com/api/get_allocation_by_alloid/${row.allo_id}`
      )
      .then((res) => {
