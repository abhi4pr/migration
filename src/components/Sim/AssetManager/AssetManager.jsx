...
const NewAssetRequestOverview = () => {
  ...
  const getManagerData = async () => {
    try {
      const response = await axios.get(
        `https://api-dot-react-migration-project.el.r.appspot.com/api/show_asset_user_data_report/${userID}`
      );
  ...
  const handleStatusUpdate = (row, status) => {
    ...
    try {
      axios.put("https://api-dot-react-migration-project.el.r.appspot.com/api/assetrequest", {
