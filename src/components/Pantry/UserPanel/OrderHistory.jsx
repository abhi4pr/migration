...
const OrderHistory = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `http://192.168.29.6:8080/api/get_single_orderreqshistory/${userId}`
      )
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .post("http://192.168.29.6:8080/api/get_delivery_boy", {
  ...
  const handlePlaceOrder = async (row) => {
    ...
    await axios.post("http://192.168.29.6:8080/api/add_orderreq", {
  ...
  const getRowDetail = (row) => {
    ...
    axios
      .get(
        `http://192.168.29.6:8080/api/get_single_productdata/${row.product_id}`
      )
      .then((res) => {
